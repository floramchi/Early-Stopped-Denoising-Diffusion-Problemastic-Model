...
if __name__ == '__main__':
    ...
    parser.add_argument('--batch_size', type=int, default=16, help='batch_size to generate images')
    ...
    parser.add_argument("--num_samples", type=int, default=1000, help='num of samples to generate, only valid when start_from_scratch is true. But when performing sr tasks, this argument will never be used')
    

    parser.add_argument('--dataset', type=str, default='imagenet64', he231lp='the dataset we are generating samples for. This will affect the model flags. Could also be lsun_bedroom, lsun_cat')
